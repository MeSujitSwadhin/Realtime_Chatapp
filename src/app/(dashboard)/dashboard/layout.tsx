...
{/* if we render all the options user have   */ }
  ...
  return (
    <div className='w-full flex h-screen'>
      <div className='flex h-full w-full max-w-xs grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6'>
        ...
        <div className='text-xs font-bold leading-6 text-gray-400'>
          Your Chat
        </div>
        <nav className='flex flex-1 flex-col'>
          <ul role='list' className='flex flex-1 flex-col gap-y-7'>
            <li>
              chats that the user have
            </li>
            <li>
            ...
            <li className='-mx-6 mt-auto flex items-center'>
              <div className='flex flex-1 items-center gap-x-4 px-5 py-2 text-sm font-semibold leading-6 text-gray-900'>
